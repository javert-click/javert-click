...
Object.defineProperty(globalThis, "Promise", { value: initPromise().Promise, writable: true, configurable: true });
...
var p0 = Promise.resolve(2).then(function (v) { return v + 1 });
var p1 = Promise.reject(21).catch(function (v) { return v * 2 });
var p2 = Promise.resolve('nope').then(function () { throw 'foo' });
var p3 = Promise.reject('yes').then(function () { throw 'nope'; });
var p4 = Promise.resolve('here').finally(function () { return 'nope' });
var p5 = Promise.reject('here too').finally(function () { return 'nope' });
var p6 = Promise.resolve('nope').finally(function () { throw 'finally'; });
var p7 = Promise.reject('nope').finally(function () { throw 'finally after rejected'; });
var p8 = Promise.reject(1).then(function () { return 'nope' }, function () { return 0 });
