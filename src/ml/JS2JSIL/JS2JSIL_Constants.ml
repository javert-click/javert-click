...
let prefix_anonymous_func_name = ref "";
...
type js_symbolic_constructs_type = {
  ...
  js_branch      : string;
	...
	js_await       : string; 
	jsil_await     : string;
	jsil_internal_await : string; 
}

let js_symbolic_constructs = {
	js_assume      = "JavertAssume"; 
  js_assert      = "JavertAssert"; 
  js_branch      = "JavertBranch";
	js_symb        = "symb";
...
let dom_imports_level1 = ["Node.jsil"; "DOM.jsil"; "Attribute.jsil"; "CDATASection.jsil"; "CharacterData.jsil"; 
													"Comment.jsil"; "ArrayUtils.jsil"; "Document.jsil"; "Element.jsil"; "NodeList.jsil"; 
													"Text.jsil"; "DocumentFragment.jsil"; "LiveNodeList.jsil"; "DocumentType.jsil"; 
													"EntityReference.jsil"; "ProcessingInstruction.jsil"; "DOMException.jsil"; "NamedNodeMap.jsil";
													"Entity.jsil"; "Notation.jsil"; "DOMImplementation.jsil"; "DocumentLoading.jsil"; "JsUnitCore.jsil"; 
...
let message_passing_imports = ["Serialization.jsil"; "MessagePassing.jsil"; "ConfSetup.jsil"]
...
let fresh_anonymous () : string =
  fresh_name ("anonymous" ^ (!prefix_anonymous_func_name)) 

let fresh_catch_anonymous () : string =
  fresh_name "catch_anonymous"

let fresh_named n : string =
  fresh_name (n ^ (!prefix_anonymous_func_name))
...
let is_main f_id = 
  (String.length f_id > 4) && (Str.string_before f_id 5) = main_fid
...
type fun_tbl_type        = (string, string * string list * JSParserSyntax.exp option * (Spec.t option) * JSParserSyntax.annotation list) Hashtbl.t
