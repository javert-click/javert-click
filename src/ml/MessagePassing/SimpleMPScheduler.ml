...
module M 
    : MPScheduler.M = struct
      ...
      **)
      ...
      let schedule (cq: ('conf) conf_q_t) (mq: ('msg) message_queue_t) (final: ('conf) conf_q_t -> bool) (ready_to_process_msg: ('conf) conf_q_t -> bool) (is_sync: 'msg -> bool) (has_transfer: 'msg -> bool) : ('conf, 'msg) scheduled_unit_t option =
        match schedule_msg cq mq ready_to_process_msg is_sync has_transfer with
        | None -> 
