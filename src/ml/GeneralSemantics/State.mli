...
module type M = sig 
      ...
      val get_domain : ?remove:bool -> t -> vt -> gd_ret 
      ...
      val simplify_formula : t -> Formula.t -> Formula.t

      (** Printer *)
      val str : ?which_store:CCommon.SS.t option -> ?which_heap:CCommon.SS.t option -> t -> string
