...
const CDATASection = require ('../Common/CDATASection');
const ProcessingInstruction = require ('../Common/ProcessingInstruction');
const Attribute = require ('./Attribute');
const EntityReference = require ('../Common/EntityReference');
